...
\usepackage{wrapfig} % Para mezclar fotos y texto
...
\begin{center}
\HRule \\[0.4cm]
{\Huge \bfseries Lab Book\\[0.5cm] \Large Sherlock and Moriarty}\\[0.4cm] % Degree
\HRule \\[1.5cm]
\end{center}
}
\author{ \Huge Alfonso B\'arragan Carmona \\ \Huge Roberto Plaza Romero \\ \Huge Javier Monescillo Buitr\'on \\ \\ \LARGE alfonsobarraga@alu.uclm.es \\ roberto.plaza@alu.uclm.es \\ javier.monescillo@alu.uclm.es \\[2cm]} % Your name and email address
\date{Inicio en 6 Octubre 2018} % Beginning date
\maketitle
...
\labday{Monday, 15 - 10 - 2018}

\experiment{Day 1: Approach to the BIG dataset}
...
\labday{Monday, 33 - 10 - 2018}

\experiment{Day 2: In the next chapter...} % Multiple experiments can be included in a single day, this allows you to segment what was done each day into separate categories
