...
def delete_columns_correlation(path_out):
    #first i have to do a copy of the dataset
    dfcopy = copy_dataset(path_out)
    for i in range(7,10):
        dfcopy = dfcopy.drop(dfcopy.columns[[i]],axis = 1)
    return dfcopy
